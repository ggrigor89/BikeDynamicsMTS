...
## Notes
The code is intentionally kept at Python 2 to preserve compatibility, as this has been a legacy project. Minor updates will be required to make it compatible with Python 3
All machine(local)-specific paths have been removed; configure them on your own via environment vars.
...
An example sumo network and simulation cfg is also provided
